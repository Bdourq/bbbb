...
export const CustodySection = () => {
  ...
  return (
    <Card id="custodySection" className="col-span-full border border-indigo-200/80 bg-white shadow-xs overflow-hidden print:hidden">
      <CardHeader 
        title="جدول العهدة الداخلي" 
        badge={custodyItems.length > 0 ? (
          <span className="text-xs font-black bg-amber-100 text-amber-900 px-2 py-0.5 rounded-md border border-amber-200 print:hidden">
            {custodyItems.length} حركة
          </span>
        ) : undefined}
        action={
          <div className="flex items-center gap-2 print:hidden">
            ...
            >
              ...
              <span className="hidden sm:inline">+ سحب (أخذ من الكاش)</span>
            ...
            >
              ...
              <span className="hidden sm:inline">+ إيداع (أعطى إلى الكاش)</span>
          ...
          <table className="w-full text-xs sm:text-sm text-right border-collapse border border-gray-300">
            <thead className="bg-gray-100 border-b border-gray-300 text-gray-700 sticky top-0 z-10">
              <tr>
                ...
                <th className="px-2 py-1 font-bold border border-gray-300 min-w-[200px] text-center">البيان</th>
